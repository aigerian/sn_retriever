...
class BaseTwitterClient(object):
    ...
    user_agent_string = 'Android-x86-1.6-r2 — Mozilla/5.0 (Linux; U; Android 1.6; en-us; eeepc Build/Donut) ' + \
                        'AppleWebKit/528.5+ (KHTML, like Gecko) Version/3.1.2 Mobile Safari/525.%i.%i' % (
                        random.randint(0, 10), random.randint(10, 100))
...
class UserClient(BaseTwitterClient):
    def __init__(self, consumer_key, consumer_secret, access_token=None, access_token_secret=None, proxies=None):
