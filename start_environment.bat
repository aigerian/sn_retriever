...
rem start %mh%\bin\mongod.exe -dbpath=%mh%\db_duplicate\ -logpath=%mh%\logs\server_duplicate.log -logappend -noauth -port=27018 --diaglog=3 --setParameter textSearchEnabled=true
